...
const slides = [
    {
      ...
      img: "https://images.pexels.com/photos/7137417/pexels-photo-7137417.jpeg",
      url: "/",
    ...
    },
    {
      ...
      description: "Sale! Up to 50% off!",
      img: "https://images.pexels.com/photos/983569/pexels-photo-983569.jpeg",
      url: "/",
            ...
            {slides.map((slide)=>(
                <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
                    ...
                    <div className=" h-1/3 sm:h-1/2  xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-12 text-center">
                        <h2 className="mt-10 text:xl lg:text-3xl 2xl:text-5xl">{slide.description}</h2>
                        <h1 className="text-5xl lg:text-6xl 2xl:text-8xl font-semibold">{slide.title}</h1>
                        <Link href={slide.url}><button className="rounded-md bg-black text-white py-3 px-4">Shop Now</button></Link>
                    </div>
                    {/* IMAGE CONTAINER */}
                    <div  className="h-2/3 sm:h-1/2  xl:w-1/2 xl:h-full relative">
